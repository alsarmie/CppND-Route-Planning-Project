...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
  ...
  for (RouteModel::Node *neighbor : current_node->neighbors) {
    ...
    if (!neighbor->visited) {
      ...
      cout << "----------------------------------------------------------" << endl;
      cout << "open_list.back->visited before: " << open_list.back()->visited << endl;
      cout << "neighbor->visited: " << open_list.back()->visited << endl;
      cout << "open_list.back->visited after: " << open_list.back()->visited << endl;
      cout << "----------------------------------------------------------" << endl;
    }
  }
}
...
void RoutePlanner::AStarSearch() {
  ...
  // Expand neighbors of the starting node
  RoutePlanner::AddNeighbors(start_node);
  cout << "Added first node neighbors!" << endl;
