...
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y,
  ...
  cout << "Closest existing node to the starting coordinate provided is ("
       << start_node->x/0.01 << " , " << start_node->y << ")" << endl;
  cout << "Closest existing node to the goal coordinate provided is ("
       << end_node->x << " , " << end_node->y << ")" << endl;
}
